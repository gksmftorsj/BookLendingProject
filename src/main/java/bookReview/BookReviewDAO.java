...
public class BookReviewDAO {
   ...
   // String sqlQuery = "SELECT reviewDateMH FROM (SELECT TO_CHAR(REVIEWDATE,
   // 'YYYY-MM-DD HH:MI')reviewDateMH, BOOKISBN, reviewNo FROM BOOK_REVIEW)"
   // + " WHERE reviewNo = ?";
   //
   // Connection conn = null;
   // PreparedStatement psmt = null;
   ...
   // {e.printStackTrace();}
   // try {if(psmt != null) conn.close();} catch (Exception e)
   // {e.printStackTrace();}
