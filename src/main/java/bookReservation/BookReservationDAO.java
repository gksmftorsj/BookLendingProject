...
public class BookReservationDAO {
	...
	public List<BookReservationDTO> selectAdminBookReservationDetailByRsDateAndRsNoAndUserNo(String rsDate, String rsNo,
			String userNo) {
		String sqlQuery = "SELECT rs.reservationDate, rs.reservationNo, rs.userNo, bl.expectedReturnDate,"
				+ " rs.bookIsbn, TO_CHAR(bl.expectedReturnDate, 'yy-mm-dd') expectedLendingDate,"
				+ " CASE WHEN length(bi.bookTitle) < 20 THEN bi.bookTitle"
	...
	public List<BookReservationDTO> selectAdminBookReservationDetailByRsDateAndTitleAndUserNo(String rsDate, String title,
			String userNo) {
		String sqlQuery = "SELECT rs.reservationDate, rs.reservationNo, rs.userNo, bl.expectedReturnDate,"
				+ " rs.bookIsbn, TO_CHAR(bl.expectedReturnDate, 'yy-mm-dd') expectedLendingDate,"
				+ " CASE WHEN length(bi.bookTitle) < 20 THEN bi.bookTitle"
