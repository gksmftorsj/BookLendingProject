	...
	<form method="post" action="./modifyUserInfoAction.jsp">
	    ...
	    <colgroup>
	      ...
	      <col width="70%">
		    ...
		    <tbody>
		      <tr>
		        <th scope="row" class="myacc_th">기존 이메일</th>
		        <td class="myacc_td"><%=userInfoDTO.getUserEmail()%></td>
		      </tr>
		      <tr>
		        <th scope="row" class="myacc_th" style="width:40px">변경할 이메일</th>
		        <td class="myacc_td"><input type="email" name="userEmail"><button type="submit" class="btn btn-primary ms-3">변경하기</button></td>
		      </tr>
		    </tbody>
	  	</table>
  	</form>
