	...
	<form method="post" action="./modifyUserInfoAction.jsp">
	    ...
	    <colgroup>
	      ...
	      <col width="70%">
		    ...
		    <tbody>
		      <tr>
		        <th scope="row" class="myacc_th">현재 비밀번호</th>
		        <td class="myacc_td"><input type="password" name="userCurrentPassword"></td>
		      </tr>
		      <tr>
		        <th scope="row" class="myacc_th" style="width:40px">변경할 비밀번호</th>
		        <td class="myacc_td"><input type="password" name="userModifyPassword"><button type="submit" class="btn btn-primary ms-3">변경하기</button></td>
		      </tr>
		    </tbody>
	  	</table>
  	</form>
