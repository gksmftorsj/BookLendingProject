...
<body>
	...
	<div id="carouselExampleInterval" class="container carousel slide mt-5"
		...
		<div class="carousel-inner d-flex justify-content-center align-items-center" style="height: 600px; background-color: lightgray;">
		<%
				for (BookInfoDTO bi : topRankBookInfoList) {
		%>
				<div class="carousel-item" datSa-bs-interval="2000" style="left: -100px">
	...
	<div class="container sortBook d-flex justify-content-end mt-5">
		<span class="me-3">랭킹순</span> 
		<span class="me-3">최신순</span> 
		<span class="me-3">이름순</span>
		<select class="form-select text-center" style="width: 160px;" onchange="selectCategory(this)">
	...
	<div class="container">
		<table class="table">
			...
			%>
				<tr>
					...
					<td><a class="bookTitle" style="text-decoration:none; color:black;" href="./bookDetail.jsp?title=<%=bi.title%>"><%=bi.title%></a></td>
					<td><%=bi.author%></td>
					<td><button style="width: 80px;"><a style="text-decoration:none; color:black;" href="./reservationAction.jsp?isbn=<%=bi.isbn%>">대여가능</a></button></td>
				</tr>	
		...
		<nav aria-label="Page navigation example" class="d-flex justify-content-center">
		  <ul class="pagination">
		    <li class="page-item">
		      <a class="page-link" href="./index.jsp?viewPage=<%=view_page-1%>" aria-label="Previous">
		    ...
		    %>
		    <li class="page-item"><a class="page-link" href="./index.jsp?viewPage=<%=i%>"><%=i%></a></li>
		    <%
		    	}
		    %>
		    <li class="page-item">
		      <a class="page-link" href="./index.jsp?viewPage=<%=view_page+1%>" aria-label="Next">
