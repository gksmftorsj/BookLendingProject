...
<body>
   ...
   <%@ include file="userNavbar.jsp"%>
         ...
         <div style="font-weight: bold; font-size: 20px; margin-top:30px; margin-left:30px; margin-bottom:20px;">
...
<!--                <div class="swiper-button-prev"></div>이전 버튼 -->
      ...
      <div class="container" style="margin: 30px;">
       <div class="row">
          ...
          <div class="col">
             <img src="./img/aladin2.jpg" style="height: 400px; width: 600px;"></img>
          </div>
      
       </div>
      </div>
      <div style="font-weight: bold; font-size: 20px; margin-left: 30px; margin-top: 30px">지니북스 top 100 도서</div>
