	...
	<form method="post" action="./modifyUserInfoAction.jsp">
	    ...
	    <colgroup>
	      ...
	      <col width="70%">
		    ...
		    <tbody>
		      <tr>
		        <th scope="row" class="myacc_th">기존 주소</th>
		        <td class="myacc_td"><%=userInfoDTO.getUserAddress()%></td>
		      </tr>
		      <tr>
		        <th scope="row" class="myacc_th" style="width:40px">변경할 주소</th>
		        <td class="myacc_td"><input type="text" name="userAddress"><button type="submit" class="btn btn-primary ms-3">변경하기</button></td>
		      </tr>
		    </tbody>
	  	</table>
  	</form>
